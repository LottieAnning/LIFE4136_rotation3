...
class G1():
    ...
    def metric_calculation(self, infile, outfile, winexclcount, file_count, win_count):
        args = self.args
        scaf = []
        pos = []
        c1_freq = []
...
#             outfile.write(string)
    ...
    def step4(self):
        ...
        header = 'scaffold\tstart\tend\tmidpoint\tlength\t'+args.coh1+'_freq\t'+args.coh2+'_freq\tabsdiff\t'+args.coh1+'_'+args.coh2+'\t'+args.coh2+'_'+args.coh1+'\tvaru\t'+args.coh1+'_pi\t'+args.coh2+'_pi\tFst\tDxy\n'
